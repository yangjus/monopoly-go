  ...
  return (
    ...
    <div className="flex justify-center py-4">
        <form className="min-h-screen w-full max-w-sm" onSubmit={handleSubmit}>
            ...
            {success === false && (
            <p className="flex items-center text-red-500 mb-4 justify-center pt-6">Login unsuccessful. Email should be all lowercase. Check that you verified your email.</p>
            )}
        </form>
    </div>
    </>
