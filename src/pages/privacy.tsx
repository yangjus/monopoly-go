...
export default function Privacy() {
    ...
    <div className="mx-auto sm:mx-16 my-4 sm:my-10">
        ...
        <h2 className="text-2xl mt-4">Information we collect</h2>
        <p>
        ...
        <p>
            MonopolyGO Trading follows a standard procedure of using log files. 
            ...
            type, Internet Service Provider (ISP), date and time stamp, referring/exit pages,
             and possibly the number of clicks. These are not linked to any information 
             that is personally identifiable. The purpose of the information is for 
             analyzing trends, administering the site, tracking users&apos; movement on the 
             website, and gathering demographic information.
        </p>

        <h2 className="text-2xl mt-4">Cookies and Web Beacons</h2>
        <p>
            Like any other website, MonopolyGO Trading uses &quot;cookies&quot;. These cookies are 
        ...
        <h2 className="text-2xl mt-4">Advertising Partners Privacy Policies</h2>
        <p>
        ...
        <p>
            ...
            and links that appear on MonopolyGO Trading, which are sent directly to 
        ...
        <h2 className="text-2xl mt-4">Third Party Privacy Policies</h2>
        <p>MonopolyGO Trading&apos;s Privacy Policy does not apply to other advertisers or websites. 
        ...
        <h2 className="text-2xl mt-4">Children&apos;s Information</h2>
        <p>
        ...
        <p>
            ...
            <a className="text-blue-500 ml-2" href="mailto:mgotrading5@gmail.com">mgotrading5@gmail.com</a>
            .
        </p>
    </div>
    )
