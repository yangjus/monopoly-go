...
export default function Verify({ user }: { user: any }) {
    ...
    <div className="flex justify-center min-h-screen">
        <div className="pt-6 sm:pt-20">
            ...
            {success === false && (
            <p className="flex items-center text-red-500 mb-4 justify-center pt-6">Verification unsuccessful. You may be verified already. If you are still having trouble verifying, please reply to the verification email sent to you.</p>
            )}
        </div>
    </div>
    )
